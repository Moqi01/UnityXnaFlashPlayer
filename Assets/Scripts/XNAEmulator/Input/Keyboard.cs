...
namespace Microsoft.Xna.Framework.Input
{
    ...
    {
        public static KeyCode[] GetKeyMapping()
        {
            return keyMapping;
        }

        public static KeyCode[] keyMapping;
   ...
   //         keyMapping[(int)Keys.Left] = KeyCode.A;
			//keyMapping[(int)Keys.Right] = KeyCode.D;
			//keyMapping[(int)Keys.Up] = KeyCode.W;
			//keyMapping[(int)Keys.Down] = KeyCode.S;
